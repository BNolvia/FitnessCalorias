...
import com.example.berenice.fitness.domain.CountDownTimerWithPause;
import com.example.berenice.fitness.domain.CurrentState;
import com.example.berenice.fitness.domain.HistoryRecord;
import com.example.berenice.fitness.domain.TrainingHelper;
import com.example.berenice.fitness.domain.Workout;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

/**
 * Created by Berenice on 09/03/2017.
 */
...
public class WorkoutActivity extends Activity {
    ...
    private void startCount(){
        ...
        doneButton.setText(getString(com.example.berenice.fitness.R.string.done));
        ...
        instructionsText.setText(String.format(getString(com.example.berenice.fitness.R.string.workout_instructions), repetitionsCount, repetitionsCount, repetitionsCount));
        createCountsView();
    }
    ...
    private void startTimer(final int sec) {
        ...
        doneButton.setText(getString(com.example.berenice.fitness.R.string.pause));
        ...
        instructionsText.setText(getString(com.example.berenice.fitness.R.string.take_break_instructions));
